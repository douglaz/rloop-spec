...
run "panel-trace  (the suite's comparator on hand-written traces, the fake past a script's last Round and probe shape, restrict_path's skip and its two refusals; the executable checks run in an Implementation's CI)" conformance/test-panel-trace
