...
class CitationControls(unittest.TestCase):
    ...
    def test_current_definitions_and_quotes(self):
        self.ids(0, "RESTATEMENT: 01-run-lifecycle.md:212", tier="ADVISORY")
    ...
    def test_restored_run16_history_has_no_quote_owner(self):
        ...
        self.ids(0, f"RESTATEMENT: {document}:212", "pick MUST start", tier="ADVISORY")
        self.assertNotIn(f"CITATION: {document}:212", self.citations())
